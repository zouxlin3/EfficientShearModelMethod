...
recorder Node -file $dataDir/SPO_${TargetFloor}_force.out -node [expr $TargetFloor * 10 + 1] [expr $TargetFloor * 10 + 2] [expr $TargetFloor * 10 + 3] [expr $TargetFloor * 10 + 4] [expr $TargetFloor * 10 + 5] [expr $TargetFloor * 10 + 6] -dof 1 reaction;
...
pattern Plain 2 Linear {
  ...
  load [expr ($TargetFloor + 1) * 10 + 6] 1 0 0;
};
