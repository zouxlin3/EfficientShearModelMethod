...
if __name__ == '__main__':
    result_path = 'F:/data_RSRP/SteelFrame/ShearModelDyn22/results.csv'
    save_path = 'F:/data_RSRP/SteelFrame/ShearModelDyn22/ErrorMetrics.csv'
    # avg_path = 'F:/data_RSRP/SteelFrame/ShearModelDyn22/ErrorAvg.csv'
    # std_path = 'F:/data_RSRP/SteelFrame/ShearModelDyn22/ErrorStd.csv'
