...
if __name__ == '__main__':
    ...
    for n, target in enumerate(targets):
        ...
        result_path = f'F:/data_RSRP/{target}g/SteelFrame/DynResults.csv'
        save_path = f'F:/data_RSRP/{target}g/SteelFrame/TimeError.csv'
        avg_path = f'F:/data_RSRP/{target}g/SteelFrame/TimeErrorAvg.csv'
        std_path = f'F:/data_RSRP/{target}g/SteelFrame/TimeErrorStd.csv'
