...
if __name__ == '__main__':
    ...
    for n, target in enumerate(targets):
        ...
        data_path = f'F:/data_RSRP/{target}g/SteelFrame3/DynResults.csv'
        max_save_path = f'F:/data_RSRP/{target}g/SteelFrame3/MaxRes.csv'
        avg_save_path = f'F:/data_RSRP/{target}g/SteelFrame3/AvgRes.csv'
